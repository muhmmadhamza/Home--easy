      ...
      <div className={`${styles["main-content-container"]} centered-content2`}>
        <div className={`${styles["header-content-container"]}`}>
          <div className={styles["header-content-title"]}>
            Sell your home, the <span>easy way.</span>
          </div>
          <div className={styles["header-content-copy"]}>
            Sell your home with HomeEasy.
          </div>
          <div className={styles["transparentprocess-content-tabs-content"]}>
            <div
              className={styles["transparentprocess-content-tabs-content-item"]}
            >
              <input
                ref={searchInputRef}
                onKeyUp={(e) => {
              ...
              {/* <div className={styles["transparentprocess-content-tabs-content-item-button-holder"]}>
                                <button onClick={()=>{
                                    ...
                                    gtmPush(["callback", "sell_hero_gs", ()=>{processPlaceSelection();}]);
